...
class opParams:
  def __init__(self):
    ...
    self.fork_params = {
                        ...
                        # STEER_SPOOF_JUMP: Param(7, VT.number, live=True),
                        MIN_STEER_SPEED: Param(50., VT.number, live=True),
                        MIN_ENABLE_SPEED: Param(60., VT.number, live=True),
}
...
# STEER_SPOOF_JUMP = 'steer_spoof_jump'
