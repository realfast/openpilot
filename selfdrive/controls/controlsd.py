...
class Controls:
  ...
  def state_control(self, CS):
    ...
    CC.longActive = self.active and self.CP.openpilotLongitudinalControl #and not self.events.any(ET.OVERRIDE)
    ...
    if not self.joystick_mode:
      ...
      actuators.steer, actuators.steeringAngleDeg, lac_log = self.LaC.update(CC.latActive, CS, self.CP, self.VM, params,
