...
class Controls:
  ...
  def publish_logs(self, CS, start_time, CC, lac_log):
    ...
    if self.CP.lateralTuning.which() == 'torque':
      if not self.CP.lateralTuning.useSteering:
        curvature = self.sm['liveLocationKalman'].angularVelocityCalibrated.value[2] / CS.vEgo + params.roll * ACCELERATION_DUE_TO_GRAVITY
