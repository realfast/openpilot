...
class CarInterfaceBase(ABC):
  ...
  @staticmethod
  def configure_torque_tune(self, candidate, tune, steering_angle_deadzone_deg=0.0, use_steering_angle=True):
    ...
    tune.torque.friction = self.CP.lateralTuning.torque.friction
