...
def acc_command(packer, counter, bus, available, enabled, accel_req=0, torque, max_gear, decel_req, decel, das_3, not_RAM = 0, stand_still = 0):
  if not_RAM == 1:
    values = {
    ...
    'ACC_DECEL': decel,
    'ENGINE_TORQUE_REQUEST_MAX': 1 if torque > 0 else 0,
