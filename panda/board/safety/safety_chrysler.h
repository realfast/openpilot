...
AddrCheckStruct chrysler_addr_checks[] = {
  {.msg = {{EPS_2, 0, 8, .check_checksum = true, .max_counter = 15U, .expected_timestep = 10000U}, {EPS_2_RAM, 0, 8, .check_checksum = false, .max_counter = 15U, .expected_timestep = 10000U}}},  // EPS module
  {.msg = {{ESP_1, 0, 8, .check_checksum = true, .max_counter = 15U,  .expected_timestep = 20000U}, {ESP_1_RAM, 0, 8, .check_checksum = false, .max_counter = 15U,  .expected_timestep = 20000U}}},  // brake pressed
  {.msg = {{ESP_8, 0, 8, .check_checksum = true, .max_counter = 15U,  .expected_timestep = 20000U}, {ESP_8_RAM, 0, 8, .check_checksum = false, .max_counter = 15U,  .expected_timestep = 20000U}}},  // vehicle Speed
  {.msg = {{ECM_5, 0, 8, .check_checksum = true, .max_counter = 15U,  .expected_timestep = 20000U}, {ECM_5_RAM, 0, 8, .check_checksum = false, .max_counter = 15U,  .expected_timestep = 20000U}}}, // gas pedal
  {.msg = {{DAS_3, 2, 8, .check_checksum = true, .max_counter = 15U, .expected_timestep = 20000U}, {DAS_3_RAM, 2, 8, .check_checksum = false, .max_counter = 15U, .expected_timestep = 20000U}}}, // forward cam ACC may need set to bus 0 to for jeep/pacifica
};
