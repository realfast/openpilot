...
const int RAM_MAX_RT_DELTA = 250;        // since 3 x the rate up from chrsyler, 3x this also NEEDS CONFIRMED
const int RAM_MAX_RATE_UP = 14;
const int RAM_MAX_RATE_DOWN = 14;
