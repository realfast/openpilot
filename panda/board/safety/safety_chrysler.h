...
const int RAM_MAX_RT_DELTA = 450;        // since 3 x the rate up from chrsyler, 3x this also NEEDS CONFIRMED
const int RAM_MAX_RATE_UP = 25;
const int RAM_MAX_RATE_DOWN = 50;
const int RAM_MAX_TORQUE_ERROR = 450;    // since 3 x the rate up from chrsyler, 3x this also NEEDS CONFIRMED
