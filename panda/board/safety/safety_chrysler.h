...
const int RAM_MAX_RT_DELTA = 200;             // since 2 x the rate up from chrsyler, 3x this also NEEDS CONFIRMED
...
const int RAM_MAX_TORQUE_ERROR = 300;         // since 2 x the rate up from chrsyler, 3x this also NEEDS CONFIRMED
